...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="small-box bg-info">
            ...
            <div class="icon"><i class="fa-solid fa-user-graduate"></i></div>
            <a href="{{ route('admin.participants.index') }}" class="small-box-footer"><i class="fa-solid fa-clone mr-2"></i>More Details</a>
        </div>
    </div>
    {{-- /.col --}}
    <div class="col-sm-4">
        <div class="small-box bg-info">
            ...
            <div class="icon"><i class="fa-solid fa-user-graduate"></i></div>
            <a href="{{ route('admin.voters.index') }}" class="small-box-footer"><i class="fa-solid fa-clone mr-2"></i>More Details</a>
        </div>
    </div>
    {{-- /.col --}}
    <div class="col-sm-4">
        <div class="small-box bg-info">
            ...
            <a href="{{ route('admin.urban-design.index') }}" class="small-box-footer"><i class="fa-solid fa-clone mr-2"></i>More Details</a>
        </div>
    </div>
    {{-- /.col --}}
</div>
